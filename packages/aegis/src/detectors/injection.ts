...
export const INJECTION_RULES: DetectorRule[] = [
  // ── Direct instruction override ──────────────────────────────────────
  {
    ...
    pattern: /\bignore\s+(?:all\s+)?(?:previous|above|prior|earlier|your|the)\s+(?:instructions|rules|guidelines|directives|constraints|prompts?)/i,
    confidence: 0.95,
  ...
  },
  {
    ...
    type: 'injection',
    subType: 'DIRECT_OVERRIDE',
    pattern: /\bforget\s+(?:all\s+)?(?:previous|above|prior|earlier|your|the)\s+(?:instructions|rules|guidelines|directives|constraints|prompts?)/i,
    confidence: 0.95,
  ...
  },
  {
    ...
    type: 'injection',
    subType: 'DIRECT_OVERRIDE',
    pattern: /\bdisregard\s+(?:all\s+)?(?:previous|above|prior|earlier|your|the)\s+(?:instructions|rules|guidelines|directives|constraints|prompts?)/i,
    confidence: 0.95,
  ...
  },
  {
    ...
    type: 'injection',
    subType: 'DIRECT_OVERRIDE',
    pattern: /\bdo\s+not\s+follow\s+(?:any\s+)?(?:previous|above|prior|earlier|your|the)\s+(?:instructions|rules|guidelines|directives|constraints|prompts?)/i,
    confidence: 0.92,
